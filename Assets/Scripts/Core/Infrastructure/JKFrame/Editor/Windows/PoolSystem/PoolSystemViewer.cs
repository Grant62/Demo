...
namespace JKFrame.Editor
{
    public class PoolSystemViewer : EditorWindow
    {
        ...
        private Dictionary<string, int> objectLayerDataIndexDic;
        private Dictionary<string, int> gameObjectLayerDataIndexDic;
        ...
        public void CreateGUI()
        {
            ...
            VisualTreeAsset visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/JKFrame/Editor/Windows/PoolSystem/PoolSystemViewer.uxml");
            ...
            foreach (KeyValuePair<string, ObjectPoolData> item in objectPoolData)
            {
                SetLayerData(objectLayerDataIndexDic, objectLayerDatas, item.Key, item.Value.PoolQueue.Count);
            }

            foreach (KeyValuePair<string, GameObjectPoolData> item in gameObjectPoolData)
            {
