...
namespace JKFrame
{
    ...
    public class UISystem : MonoBehaviour
    {
        ...
        private static Dictionary<string, UIWindowData> UIWindowDataDic { get => JKFrameRoot.Setting.UIWindowDataDic; }
        ...
        [SerializeField] private GameObject UITipsItemPrefab;
        ...
        {
            Dictionary<string, UIWindowData>.Enumerator enumerator = UIWindowDataDic.GetEnumerator();
        ...
        {
            // 处理缓存中所有状态的逻辑
            foreach (UIWindowData item in UIWindowDataDic.Values)
            {
        ...
        public static void AddTips(string tips)
        {
            ...
            if (item == null) item = Instantiate(instance.UITipsItemPrefab, instance.UITipsItemParent).GetComponent<UITipsItem>();
            item.Init(tips);
        }
        #endregion

        #region 工具
        private static readonly List<RaycastResult> raycastResultList = new();
