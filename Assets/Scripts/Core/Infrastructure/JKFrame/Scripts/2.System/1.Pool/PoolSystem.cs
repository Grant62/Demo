    ...
    public static class PoolSystem
    {
        ...
        public static void InitGameObjectPool(string keyName, int maxCapacity = -1, GameObject prefab = null, int defaultQuantity = 0)
        {
            ...
            if (JKFrameRoot.EditorEventModule != null)
                JKFrameRoot.EditorEventModule.EventTrigger("OnInitGameObjectPool", keyName, defaultQuantity);
#endif
        }
...
#if UNITY_EDITOR
            if (JKFrameRoot.EditorEventModule != null)
                JKFrameRoot.EditorEventModule.EventTrigger("OnInitGameObjectPool", keyName, gameObjects.Length);
#endif
        }
...
#if UNITY_EDITOR
            if (go != null && JKFrameRoot.EditorEventModule != null) JKFrameRoot.EditorEventModule.EventTrigger("OnGetGameObject", keyName, 1);
#endif
            return go;
        }
        ...
        public static bool PushGameObject(string keyName, GameObject obj)
        {
            if (!obj.IsNull())
            {
                ...
                if (JKFrameRoot.EditorEventModule != null && res)
                    JKFrameRoot.EditorEventModule.EventTrigger("OnPushGameObject", keyName, 1);
#endif
                return res;
            }
...
#if UNITY_EDITOR
            if (JKFrameRoot.EditorEventModule != null)
                JKFrameRoot.EditorEventModule.EventTrigger("OnClearGameObject", keyName);
#endif
        }
        #endregion
...
#if UNITY_EDITOR
            if (JKFrameRoot.EditorEventModule != null)
                JKFrameRoot.EditorEventModule.EventTrigger("OnInitObjectPool", keyName, defaultQuantity);
#endif
        }
...
#if UNITY_EDITOR
            if (JKFrameRoot.EditorEventModule != null)
                JKFrameRoot.EditorEventModule.EventTrigger("OnInitObjectPool", keyName, 0);
#endif
        }
...
#if UNITY_EDITOR
            if (JKFrameRoot.EditorEventModule != null)
                JKFrameRoot.EditorEventModule.EventTrigger("OnInitObjectPool", type.FullName, 0);
#endif
        }
        ...
        public static object GetObject(string keyName)
        {
            ...
            {
                if (JKFrameRoot.EditorEventModule != null)
                    JKFrameRoot.EditorEventModule.EventTrigger("OnGetObject", keyName, 1);
            }
#endif
            return obj;
        }
        ...
        public static bool PushObject(object obj, string keyName)
        {
            ...
            if (JKFrameRoot.EditorEventModule != null && res)
            {
                JKFrameRoot.EditorEventModule.EventTrigger("OnPushObject", keyName, 1);
            }
#endif
            return res;
        }
        ...
        public static void ClearObject(string keyName)
        {
            ...
            if (JKFrameRoot.EditorEventModule != null)
            {
                JKFrameRoot.EditorEventModule.EventTrigger("OnClearnObject", keyName);
            }
#endif
